...
public class CRUDClassExample {
    public CRUDClassExample() {
...
//        updateUsers("3", "일지매_수정후");
    ...
    private void selectUsers() {
        ...
        try {
            conn = DBConnectionExample.getConnection();
            ...
            DBConnectionExample.close(rs, pstmt, conn);
        }
    ...
    private void updateUsers(String id, String name) {
        ...
        try {
            ...
            DBConnectionExample.close(pstmt, conn);
        }
    ...
    private void createTable() {
        ...
        try {
            ...
            DBConnectionExample.close(stmt, conn);
        }
